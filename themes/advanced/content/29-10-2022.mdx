...
You can use a variety of grains with success, but the most popular is rye berries. It has a great water capacity and is pretty durable. For more info on what grains you can use, check out this great [article](https://learn.freshcap.com/learn/different-types-of-grain-spawn/) from FreshCap.
