...
const config: SiteConfig = {
  ...
  website: {
    ...
    titleShort: "SimpleSpore", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    ...
    url: "https://www.simplespore.com", // Domain of your website without the pathPrefix
